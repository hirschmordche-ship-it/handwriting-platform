  ...
  en: {
    ...
    html: (code) => `
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:auto;padding:20px;text-align:center;">
        ...
        <p style="color:#666;">Use the secure code below to update your password. If you didn't request this, you can ignore it.</p>
        ...
        <p style="margin-top:25px; font-size:14px; color:#999;">Expires in 10 minutes.</p>
      </div>
    `
  },
  he: {
    ...
    html: (code) => `
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:auto;padding:20px;direction:rtl;text-align:center;">
        ...
        <p style="color:#666;">השתמש בקוד המאובטח למטה כדי לעדכן את הסיסמה שלך:</p>
        <div style="display:inline-block;padding:16px 32px;background:#4A90E2;color:white;border-radius:12px;font-size:32px;font-weight:bold;letter-spacing:4px;">
          ${code}
        </div>
        <p style="margin-top:25px; font-size:14px; color:#999;">הקוד בתוקף ל-10 דקות.</p>
      </div>
    `
  }
};
