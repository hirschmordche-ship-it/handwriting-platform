...
<a if(navigator.clipboard){
        navigator.clipboard.writeText(text)
          .then(()=>showSnackbar(State.lang === 'he' ? 'הועתק ללוח' : 'Copied to clipboard'))
          .catch(()=>showSnackbar(State.lang === 'he' ? 'ההעתקה נכשלה' : 'Copy failed'));
      }else{
        showSnackbar(State.lang === 'he' ? 'הלוח אינו זמין' : 'Clipboard not available');
      }
      return;
    }
